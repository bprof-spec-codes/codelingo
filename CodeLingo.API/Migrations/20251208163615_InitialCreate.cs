        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    AchievementId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CodeCompletionQuestions", x => x.QuestionId);
                    table.ForeignKey(
                        name: "FK_CodeCompletionQuestions_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_ProgrammingLanguageId",
                table: "Questions",
